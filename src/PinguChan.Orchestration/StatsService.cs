...
public sealed class StatsService : IStatsService
{
    ...
    private readonly Dictionary<Key, LinkedList<(DateTimeOffset ts, bool ok)>> _data = new();
    ...
    public void Observe(NetSample sample)
    {
        ...
        {
            list = new LinkedList<(DateTimeOffset, bool)>();
            _data[key] = list;
        }
        list.AddLast((sample.Timestamp, sample.Ok));
